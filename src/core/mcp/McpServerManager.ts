...
import type { CodexdianMcpServer, McpServerConfig } from '../types';

/** Storage interface for loading MCP servers. */
export interface McpStorageAdapter {
  load(): Promise<CodexdianMcpServer[]>;
}
...
export class McpServerManager {
  ...
  private collectDisallowedTools(filter?: (server: CodexdianMcpServer) => boolean): string[] {
  ...
  getContextSavingServers(): CodexdianMcpServer[] {
