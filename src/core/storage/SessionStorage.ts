/**
 * SessionStorage - Handles chat session files in vault/.codex/sessions/
 *
...
export const SESSIONS_PATH = '.codex/sessions';
  ...
  async listNativeMetadata(): Promise<SessionMetadata[]> {
    ...
    try {
      ...
      for (const filePath of metaFiles) {
        // Extract ID from path: .codex/sessions/{id}.meta.json
