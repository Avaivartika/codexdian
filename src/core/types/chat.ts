...
export const VIEW_TYPE_CODEXDIAN = 'codexdian-view';
...
export interface Conversation {
  ...
  /** True if this conversation uses SDK-native storage (messages in ~/.codex/projects/). */
  isNative?: boolean;
...
export interface SessionMetadata {
   ...
   * Stored here because SDK session files don't preserve this Codexdian-specific data.
   */
  subagentData?: Record<string, SubagentInfo>;
  /** Assistant UUID for resumeSessionAt after rewind. */
  resumeSessionAt?: string;
...
/** Normalized stream chunk from the Codex SDK compatibility layer. */
