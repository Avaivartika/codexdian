...
export class InlineExitPlanMode {
  ...
  render(): void {
    ...
    approveRow.createSpan({ text: '\u00A0', cls: 'codexdian-ask-cursor' });
    ...
    feedbackRow.createSpan({ text: '\u00A0', cls: 'codexdian-ask-cursor' });
    ...
    this.rootEl.createDiv({ text: HINTS_TEXT, cls: 'codexdian-ask-hints' });
