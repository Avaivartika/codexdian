...
export class SubagentManager {
  ...
  private updateSubagentLabel(
    ...
    if (description) {
      ...
      const labelEl = wrapperEl.querySelector('.codexdian-subagent-label') as HTMLElement | null;
      if (labelEl) {
    ...
    if (prompt) {
      info.prompt = prompt;
      const promptEl = wrapperEl.querySelector('.codexdian-subagent-prompt-text') as HTMLElement | null;
      if (promptEl) {
