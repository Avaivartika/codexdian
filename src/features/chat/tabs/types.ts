 ...
 * - Each tab has its own CodexService and persistent query
...
/**
 * Minimal interface for the CodexdianView methods used by TabManager and Tab.
 * Extends Component for Obsidian integration (event handling, cleanup).
 * Avoids circular dependency by not importing CodexdianView directly.
 */
...
export interface TabData {
  ...
  /** Per-tab CodexService instance for independent streaming. */
