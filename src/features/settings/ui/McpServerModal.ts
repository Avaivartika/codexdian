...
export class McpServerModal extends Modal {
  ...
  private existingServer: CodexdianMcpServer | null;
  private onSave: (server: CodexdianMcpServer) => void;
  ...
  constructor(
    ...
    existingServer: CodexdianMcpServer | null,
    onSave: (server: CodexdianMcpServer) => void,
