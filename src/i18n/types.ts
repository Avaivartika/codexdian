...
export type TranslationKey =
  ...
  // Settings - Advanced
  | 'settings.advanced'
  | 'settings.enableGPT54HighContext.name'
  | 'settings.enableGPT54HighContext.desc'
  | 'settings.enableGPT53CodexHighContext.name'
  | 'settings.enableGPT53CodexHighContext.desc'
