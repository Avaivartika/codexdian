/**
 * Codexdian - Slash command dropdown
 *
 ...
 * These are either handled differently in Codexdian or don't apply.
 */
...
export class SlashCommandDropdown {
  ...
  private buildCommandList(builtInCommands: SlashCommand[]): SlashCommand[] {
    ...
    // Add Codexdian built-in commands first (highest priority)
  ...
  private updateSelection(): void {
    const items = this.dropdownEl?.querySelectorAll('.codexdian-slash-item');
