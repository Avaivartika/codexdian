 ...
 * Handles both our custom .codexdian-file-link and Obsidian's .internal-link.
 */
export function registerFileLinkHandler(
  ...
  component.registerDomEvent(container, 'click', (event: MouseEvent) => {
    ...
    const link = target.closest('.codexdian-file-link, .internal-link') as HTMLAnchorElement;
