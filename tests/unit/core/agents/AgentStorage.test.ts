...
You are helpful.`;
    ...
    expect(parsed?.frontmatter.model).toBe('gpt-5.3-codex');
...
describe('parseModel', () => {
  ...
  it('returns gpt-5.3-codex for valid gpt-5.3-codex input', () => {
    expect(parseModel('gpt-5.3-codex')).toBe('gpt-5.3-codex');
  });

  it('returns gpt-5.4 for valid gpt-5.4 input', () => {
    expect(parseModel('gpt-5.4')).toBe('gpt-5.4');
  });

  it('returns gpt-5.1-codex-mini for valid gpt-5.1-codex-mini input', () => {
    expect(parseModel('gpt-5.1-codex-mini')).toBe('gpt-5.1-codex-mini');
  });
  ...
  it('returns inherit for invalid model value', () => {
    expect(parseModel('codex-3')).toBe('inherit');
