...
function createMockContextRow(browserIndicator: HTMLElement) {
  ...
  const elements: Record<string, any> = {
    '.codexdian-selection-indicator': { style: { display: 'none' } },
    '.codexdian-browser-selection-indicator': browserIndicator,
    '.codexdian-canvas-indicator': { style: { display: 'none' } },
    '.codexdian-file-indicator': fileIndicator,
    '.codexdian-image-preview': imagePreview,
  };
