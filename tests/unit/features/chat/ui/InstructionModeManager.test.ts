...
describe('InstructionModeManager', () => {
  it('should enter instruction mode on # keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('codexdian-input-instruction-mode');
  });
  ...
  it('should exit instruction mode when input is cleared', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('codexdian-input-instruction-mode');
  });
