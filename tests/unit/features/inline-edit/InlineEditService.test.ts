...
describe('InlineEditService', () => {
  ...
  describe('editText', () => {
    ...
    it('should set settingSources to project only when loadUserCodexSettings is false', async () => {
      mockPlugin.settings.loadUserCodexSettings = false;
      service = new InlineEditService(mockPlugin);
    ...
    it('should set settingSources to include user when loadUserCodexSettings is true', async () => {
      mockPlugin.settings.loadUserCodexSettings = true;
      service = new InlineEditService(mockPlugin);
    ...
    it('should set adaptive thinking for Codex models', async () => {
      mockPlugin.settings.model = 'gpt-5.3-codex';
      service = new InlineEditService(mockPlugin);
