...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'codexdian-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'codexdian-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'codexdian-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.style.display).not.toBe('none');

      const clarificationEl = findByClass(contentEl, 'codexdian-instruction-clarification-section');
      expect(clarificationEl.style.display).toBe('none');

      const confirmationEl = findByClass(contentEl, 'codexdian-instruction-confirmation-section');
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'codexdian-instruction-btn');
  ...
  describe('showClarification', () => {
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'codexdian-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'codexdian-instruction-refined');
